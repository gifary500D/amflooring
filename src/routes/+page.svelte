<script lang="ts">
	...
	const testimonials = [
		{
			name: 'Budi Santoso',
			role: 'Pemilik GOR Merdeka',
			text: 'Pelayanan AMFlooring sangat memuaskan. Lapangan futsal kami selesai tepat waktu dengan kualitas terbaik.',
			rating: 5
		},
		{
			name: 'Sari Indah',
			role: 'Manager Sport Center',
			text: 'Tim profesional dan hasil pekerjaan yang sangat rapi. Sangat direkomendasikan!',
			rating: 5
		},
		{
			name: 'Ahmad Wijaya',
			role: 'Kepala Sekolah',
			text: 'Renovasi lapangan basket sekolah kami berjalan lancar. Terima kasih AMFlooring!',
			rating: 5
		}
	];
	...
	const contactInfo = [
		{
			...
			link: 'https://wa.me/6282xxxxxxxx',
			desc: 'Chat langsung untuk konsultasi'
		},
		{
			icon: '📞',
			title: 'Telepon',
			value: '+62 821-xxxx-xxxx',
			link: 'tel:+6282xxxxxxxx',
			desc: 'Hubungi kami langsung'
		},
		{
			icon: '✉️',
			title: 'Email',
			value: 'info@amflooring.com',
			link: 'mailto:info@amflooring.com',
			desc: 'Kirim detail proyek Anda'
		},
		{
			icon: '📍',
			title: 'Alamat',
			value: 'Jl. Olahraga No. 123, Medan',
...
<!-- Navbar -->
<nav
	class="fixed top-0 right-0 left-0 z-50 bg-white/95 shadow-lg backdrop-blur-md transition-all duration-300"
>
	<div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
		<div class="flex items-center space-x-2">
			<div
				class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-emerald-600 to-teal-700"
			>
				<img
		...
		<div class="hidden space-x-8 md:flex">
			<a
				href="#home"
				class="group relative font-medium text-gray-700 transition-colors duration-300 hover:text-emerald-600"
			>
				Beranda
				<span
					class="absolute -bottom-1 left-0 h-0.5 w-0 bg-emerald-600 transition-all duration-300 group-hover:w-full"
				></span>
			</a>
			<a
				href="#about"
			...
			<a
				href="#kontak"
				class="transform rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-2 text-white shadow-lg transition-all duration-300 hover:scale-[1.02] hover:from-emerald-700 hover:to-teal-700"
			>
				Kontak
			</a>
		</div>
		...
		<button class="md:hidden" on:click={toggleMenu}>
			<div class="flex h-6 w-6 flex-col items-center justify-center">
				<span
					class="h-0.5 w-6 bg-gray-700 transition-all duration-300 {isMenuOpen
						? 'translate-y-1 rotate-45'
						: ''}"
				></span>
				<span
					class="mt-1 h-0.5 w-6 bg-gray-700 transition-all duration-300 {isMenuOpen
						? 'opacity-0'
						: ''}"
				></span>
				<span
	...
	<div
		class="overflow-hidden transition-all duration-300 md:hidden {isMenuOpen
			...
			: 'max-h-0'}"
	>
		<div class="space-y-4 border-t bg-white px-4 py-4 sm:px-6">
			<a
				href="#home"
				class="block text-gray-700 transition-colors duration-300 hover:text-emerald-600">Beranda</a
			>
			<a
				href="#about"
				class="block text-gray-700 transition-colors duration-300 hover:text-emerald-600">Tentang</a
			>
			<a
				href="#layanan"
				class="block text-gray-700 transition-colors duration-300 hover:text-emerald-600">Layanan</a
			>
			<a
				href="#visi"
				class="block text-gray-700 transition-colors duration-300 hover:text-emerald-600"
				>Visi & Misi</a
			>
			<a
				href="#kontak"
				class="block rounded-lg bg-emerald-600 px-4 py-2 text-center text-white transition-colors duration-300 hover:bg-emerald-700"
				>Kontak</a
			>
		</div>
	</div>
...
<!-- Back to Top Button -->
<button
	class="fixed right-4 bottom-4 z-50 h-12 w-12 transform rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white opacity-80 shadow-lg transition-all duration-300 hover:scale-[1.05] hover:from-emerald-700 hover:to-teal-700 hover:opacity-100"
